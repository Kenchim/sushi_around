...
class getGooglemapsPlaceId{
  static Future<List> placeIdFromCurrentPosition(double lat, double lng) async {
    String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?keyword=sushi&location=${lat}%2C${lng}&radius=500&type=restaurant&key=${API_KEY}";
    List placeIdList = [];
    try{
      ...
      print("${placeIdList}placeidlistの取得");
      return placeIdList;
    } catch(e){
      print(e);
      return null!;
